        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 40),
              _LabeledField(label: 'Correo electrónico', hint: 'alex@fluent.app', keyboardType: TextInputType.emailAddress),
              const SizedBox(height: 28),
              _LabeledField(label: 'Contraseña', hint: '••••••••', obscure: true),
              const Spacer(),
              FluentButton(
                label: 'Crear cuenta',
                ...
                child: RichText(
                  ...
                  text: const TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: 'Términos', style: TextStyle(color: AppColors.textPrimary)),
                      TextSpan(text: ' y la '),
                      TextSpan(text: 'Política de privacidad', style: TextStyle(color: AppColors.textPrimary)),
                      TextSpan(text: '.'),
                    ],
                  ),
                ),
